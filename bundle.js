...
/***/ (function(module, exports, __webpack_require__) {
	...
	var API_KEY = 'AIzaSyC6qS5jccFB6h8t1uDskZcEFXOXj0tWnU4';
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.videoSearch('net neutrality');
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function videoSearch(searchTerm) {
	      ...
	      (0, _youtubeApiSearch2.default)({ key: API_KEY, term: searchTerm }, function (videos) {
	        _this2.setState({
	          videos: videos,
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_search_bar2.default, { onSearchTermChange: function onSearchTermChange(searchTerm) {
